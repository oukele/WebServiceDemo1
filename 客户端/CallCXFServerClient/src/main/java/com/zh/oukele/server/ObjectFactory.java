 ...
 * generated in the com.zh.oukele.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetInfo_QNAME = new QName("http://server.oukele.zh.com", "getInfo");
    private final static QName _GetInfoResponse_QNAME = new QName("http://server.oukele.zh.com", "getInfoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zh.oukele.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.oukele.zh.com", name = "getInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.oukele.zh.com", name = "getInfoResponse")
